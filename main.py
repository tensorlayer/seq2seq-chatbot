...
def initial_setup(data_corpus):
    ...
    (trainX, trainY), (testX, testY), (validX, validY) = data.split_dataset(
        idx_q, idx_a)
...
if __name__ == "__main__":
    ...
    def inference(seed):
        ...
        sentence_id = model_(
            inputs=[seed_id], seq_length=30, start_token=start_id)
        sentence = []
        ...
        for X, Y in tqdm(
            ...
            if n_iter % 50 == 0:
                print('Epoch [{}/{}][{}]: loss {:.4f}'.format(
                    epoch + 1, num_epochs, n_iter, total_loss / n_iter))
